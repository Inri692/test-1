    ...
    <Layout>
      <div className="relative mb-10">
        <div className="flex flex-col md:flex-row">
          <div className="flex-col w-full md:w-2/5">
            <div className="pt-16 absolute left-1/3 md:mx-9">
              <img src={dot1} alt="dot1" />
            </div>

            <div className="flex flex-col z-40 absolute left-0 sm:top-2 md:left-52 top-36 md:top-1/2 md:transform md:-translate-y-1/2">
              <button className="rounded-none hidden sm:block text-4xl sm:text-lg md:text-6xl border border-black bg-white h-20 md:h-24 font-bold">
                Build or scale up
              </button>
              <h1 className="text-3xl md:text-5xl mt-5 hidden sm:block">
                your development team
              </h1>
              <div className="flex flex-row mt-5 hidden sm:block">
                <div className="h-1 bg-[#FFCE07] mt-5 w-16 md:w-24"></div>
                <p className="mt-2 mx-4 text-base md:text-lg">
                  in weeks, not months
                </p>
              </div>

              <button className="rounded-full bg-[#FFCE07] hidden sm:block w-36 md:w-44 h-12 md:h-14 font-bold m-2 border border-black mt-5">
                Book now
              </button>
            </div>
          </div>
          <div className="flex w-full md:w-3/5">
            <div className="flex flex-col">
              ...
              <div className="absolute bottom-0 left-1/2 md:left-2/4 md:mx-20">
                <img src={dot2} alt="" />
              </div>
            </div>
          </div>
      ...
      <div className="container">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 justify-items-center gap-5 mt-5 mx-32">
          {products.map((item) => (
            <Card1
              key={item.id}
              image={item.image}
        ...
        <div className="grid grid-cols-2 md:grid-cols-6 mx-4 md:mx-28 mt-16 justify-items-center gap-10">
          {techs.map((items) => (
      ...
      <div className="bg-[#272727] h-56 text-white sm:h-96 md:h-96">
        <div className="grid justify-items-center text-[#FFCE07] md:text-2xl md:m-6 font-bold pt-5">
          <h1>Our Progress Comes With a Collaboration Between</h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 justify-items-center">
          <div className="flex flex-col text-center sm:text-left">
            <div className="md:text-5xl">1000+</div>
            <div className="">designs</div>
          </div>
          <div className="flex flex-col text-center sm:text-left">
            <div className="md:text-5xl">30+</div>
            <div className="">products</div>
          </div>
          <div className="flex flex-col text-center sm:text-left">
            <div className="md:text-5xl">58+</div>
      ...
      <div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 justify-items-center mt-8 mx-4 sm:mx-12 md:mx-16 lg:mx-28">
          {softwares.map((item) => (
            <Card3
              key={item.id}
              image={item.image}
      ...
      <div className="relative">
        ...
        <div className="bg-[url('./public/bg.jpeg')] h-screen bg-no-repeat bg-contain bg-center static">
          <div className="hidden sm:block absolute left-32 top-36 ">
          ...
          <div className="hidden sm:block inline-block absolute right-0 top-1/4 ">
          ...
          <div className="hidden sm:block absolute right-20 top-2/4 ">
          ...
          <div className="hidden sm:block absolute left-1/4 top-3/4 ">
            <p className="text-[#272727] text-sm font-bold">Amazing people</p>
            <p className="text-[#272727] text-sm w-1/2">
              "They are people who are not only following the tasks, but can
              work as a team. Together."
